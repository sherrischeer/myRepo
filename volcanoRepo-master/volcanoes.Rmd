...
The following packages are required. If not already installed, do so using 

##Visualizing Elevation of Volcanoes with Persistent Lava Lakes`install.packages`: 
`ggplot2`
`dplyr`
`readxl`
